		       ...
		       struct xnvme_be_nvmf_qpair *qpair)
{
	...
	rdma_qpair->qp_init_attr.cap.max_send_wr = 128 +
						   XNVME_NVMF_QPAIR_ASYNC_SEND_RESERVE;
	rdma_qpair->qp_init_attr.cap.max_recv_wr = 128 +
						   XNVME_NVMF_QPAIR_ASYNC_RECV_RESERVE;
