...
int
xnvme_be_upcie_hip_sync_cmd_io(struct xnvme_cmd_ctx *ctx, void *dbuf, size_t dbuf_nbytes,
...
int
xnvme_be_upcie_hip_sync_cmd_iov(struct xnvme_cmd_ctx *ctx, struct iovec *dvec, size_t dvec_cnt,
...
struct xnvme_be_sync g_xnvme_be_upcie_hip_sync = {
	.id = "upcie-hip-cpuinit",
#ifdef XNVME_BE_UPCIE_HIP_ENABLED
	.cmd_io = xnvme_be_upcie_hip_sync_cmd_io,
	.cmd_iov = xnvme_be_upcie_hip_sync_cmd_iov,
#else
