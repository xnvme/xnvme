...
int
xnvme_be_upcie_hip_sync_cmd_admin(struct xnvme_cmd_ctx *ctx, void *dbuf, size_t dbuf_nbytes,
...
struct xnvme_be_admin g_xnvme_be_upcie_hip_admin = {
	.id = "upcie-hip-cpuinit",
#ifdef XNVME_BE_UPCIE_HIP_ENABLED
	.cmd_admin = xnvme_be_upcie_hip_sync_cmd_admin,
