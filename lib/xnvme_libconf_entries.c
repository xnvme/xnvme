...
static const char *g_libconf_strings[] = {
	...
	"conf: XNVME_PLATFORM_WINDOWS_ENABLED",
#endif
	...
	"conf: XNVME_PLATFORM_LINUX_ENABLED",
#endif
	...
	"conf: XNVME_PLATFORM_MACOS_ENABLED",
#endif
#ifdef XNVME_PLATFORM_FREEBSD_ENABLED
	"conf: XNVME_PLATFORM_FREEBSD_ENABLED",
#endif
