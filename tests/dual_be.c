...
sub_idfy_cmp(struct xnvme_cli *cli)
{
	...
	if (diff) {
		...
		printf("PASS: Identify Namespace responses match (%zu bytes)\n", sizeof(*idfy));
	}
...
static struct xnvme_cli_sub g_subs[] = {
	...
	{
		"idfy-cmp",
		"Send Identify Namespace via --be and --alt-be, compare responses",
		"Issue an Identify Namespace command through each of the two backends\n"
