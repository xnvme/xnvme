...
enum xnvme_spec_idfy_cns {
	...
	XNVME_SPEC_IDFY_TBD_NSTP = 0x18, ///< XNVME_SPEC_IDFY_TBD_NSTP
};
 ...
 */
enum xnvme_spec_nstype {
	XNVME_SPEC_NSTYPE_LBLK		= 0x0,	///< XNVME_SPEC_NSTYPE_LBLK
	XNVME_SPEC_NSTYPE_ZONED		= 0x1,	///< XNVME_SPEC_NSTYPE_ZONED

	XNVME_SPEC_NSTYPE_NOCHECK	= 0xFF,	///< XNVME_SPEC_NSTYPE_NOCHECK
};

/**
 * Produces a string representation of the given ::xnvme_spec_nstype
 *
 ...
 * "XNVME_SPEC_NSTYPE_ENOSYS" is returned.
 */
const char *
