...
"""
    ...
    The purpose of a library-bundle is to ease the task of linking with a
    project and satisfy its dependencies. For example, libfoo consisting
    provide its own functionality and depends on libx, liby and libz. Instead
