...
Additionally, the host-memory backend supports a **{ref}`sec-backends-upcie-
cplane`** mode in which several processes share a single NVMe controller via a
designated server process.
