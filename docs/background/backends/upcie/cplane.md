...
coarse one. Handing out only the doorbell page a client was allocated would be
...
platform, and gets it only while the IOMMU passes through. The queue lives in device memory and the doorbell has to be in
