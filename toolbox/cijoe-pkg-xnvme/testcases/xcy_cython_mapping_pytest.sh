#!/bin/bash
 ...
 if ! cij.cmd "XNVME_URI=${XNVME_URI} XNVME_BE=${XNVME_BE} XNVME_DEV_NSID=${XNVME_DEV_NSID} python3 -m pytest --cython-collect ${XNVME_REPO}/python/xnvme-core/xnvme/cython_mapping/tests/ -v -s"; then
   test.fail
 fi
