...
$env:PATH = "$env:SystemDrive\tools\msys64;$env:PATH"
$env:PATH = "$env:SystemDrive\tools\msys64\usr\lib;$env:PATH"
$env:PATH = "$env:SystemDrive\tools\msys64\usr\bin;$env:PATH"
