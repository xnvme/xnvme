...
def gen_flags(args):
    ...
    regex = re.compile(r"^conf_data.set\('(?P<flag>[a-zA-Z_]+_ENABLED)'")
    flags = []
...
def update(args):
    ...
    ver += "#include <libxnvme_libconf.h>\n"
    ver += "static const char *g_libconf_strings[] = {\n"
    ...
    ver += "static struct xnvme_libconf g_libconf = {.entries = g_libconf_strings};"
